...
export function createWiredSection(cfg: NetworkWidgetConfig, service: NetworkService) {
  ...
  wiredBody.add_css_class("network-section-body")
  const wiredRow = new Gtk.Box({ orientation: Gtk.Orientation.HORIZONTAL, spacing: 10 })
  wiredRow.add_css_class("network-row")
  ...
  wiredInterface.add_css_class("network-row-meta")
  const wiredDetailsBtn = new Gtk.Button({ label: "Details" })
  wiredDetailsBtn.add_css_class("network-action")
  ...
  wiredDetailsBox.add_css_class("network-details")
  ...
  wiredConnLabel.add_css_class("network-details-label")
  const wiredConnValue = new Gtk.Label({ label: "--", xalign: 0 })
  wiredConnValue.add_css_class("network-details-value")
  ...
  wiredIfaceLabel.add_css_class("network-details-label")
  const wiredIfaceValue = new Gtk.Label({ label: "--", xalign: 0 })
  wiredIfaceValue.add_css_class("network-details-value")
  ...
  wiredIpLabel.add_css_class("network-details-label")
  const wiredIpValue = new Gtk.Label({ label: "--", xalign: 0 })
  wiredIpValue.add_css_class("network-details-value")
  ...
  wiredCollapsedInfo.add_css_class("network-section-collapsed-info")
  const wiredCollapsedIcon = new Gtk.Image({ pixel_size: 16 })
  wiredCollapsedIcon.add_css_class("network-section-collapsed-icon")
  const wiredCollapsedLabel = new Gtk.Label({ label: "No connection", xalign: 0 })
  wiredCollapsedLabel.add_css_class("network-section-collapsed-text")
  ...
  wiredRefreshBtn.connect("clicked", () => {
    startWiredSpin(700)
    service.refresh()
      .catch(err => console.error("network refresh error", err))
      .finally(() => {
